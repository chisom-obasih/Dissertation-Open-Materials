---
title: "Study 3 Data Cleaning and Exploratory Visualization"
author: "Chisom Obasih"
date: "June 2025"
subtitle: "Cleaning and wrangling raw data of pre/post-training Visual Analog Scale (VAS) task, discrimination pre/post-tests, discrimination training, and linguistic diversity questionnaire, from Study 3 of dissertation, with some exploratory visualizations"
output: 
  pdf_document:
...
VAS_files <- list.files(path = "data/raw/VAS", pattern = "*.csv", all.files = FALSE, full.names = TRUE, recursive = FALSE)
AX_test_files <- list.files(path = "data/raw/AX_test", pattern = "*.csv", all.files = FALSE, full.names = TRUE, recursive = FALSE)
AX_training_files <- list.files(path = "data/raw/AX_training", pattern = "*.csv", all.files = FALSE, full.names = TRUE, recursive = FALSE)
MCPD_files <- list.files(path = "data/raw/MCPD", pattern = "*.csv", all.files = FALSE, full.names = TRUE, recursive = FALSE)
...
MLD_scores <- import(file = "data/analyzed_results/study3_mld_scores.csv") %>%
...
# load("Rdata/study3_data_cleaning_workspace.Rdata")
```
...
save(VAS_df,
     ...
     file = "Rdata/study3_data_cleaning_workspace.Rdata")
...
save(clean_IDs,
     ...
     lowLD_training_dprime,
     highLD_training_dprime,
     file = "Rdata/study3_processed_dataframes_filtered_only.Rdata")
...
write_excel_csv(clean_mcpd_df, file = "data/processed/unfiltered_study3_mcpd_all.csv")
```
...
write_excel_csv(filtered_mcpd, file = "data/processed/filtered_study3_mcpd.csv")
```
...
# save as csv file, saves in subfolder
write_excel_csv(clean_vas_df, file = "data/processed/unfiltered_study3_vas_all.csv")
```
...
export(filtered_vas_mad, "data/processed/filtered_study3_vas.csv", row.names = F, quote = F)

# save matlab (with less columns) as txt file
export(filtered_matlab, "data/processed/filtered_study3_vas_matlab.txt", sep = "\t", row.names = F, quote = F)
...
# save as csv file, saves in subfolder
write_excel_csv(clean_ax_test_df, file = "data/processed/unfiltered_study3_AX_testing_all.csv")
```
...
# save filtered (with all the columns) as csv file
write_excel_csv(filtered_ax_test_mad, "data/processed/filtered_study3_ax_test_full_metadata.csv")

# save filtered (with less columns) as csv file
write_excel_csv(filtered_ax_test, "data/processed/filtered_study3_ax_test.csv")
...
# save as csv file, saves in subfolder
write_excel_csv(clean_training_df, file = "data/processed/unfiltered_study3_AX_training_all.csv")
```
...
# save filtered (with all the columns) as csv file
write_excel_csv(filtered_training_mad, "data/processed/filtered_study3_AX_training_full_metadata.csv")

# save filtered (with less columns) as csv file
write_excel_csv(filtered_training, "data/processed/filtered_study3_AX_training.csv")
...
cowplot::save_plot(vas.control, filename = "exploratory_visualization/prepost-vas/prepost-vas-control.png", nrow = 2, ncol = 3, base_asp = 1.2)
...
cowplot::save_plot(vas.lowld, filename = "exploratory_visualization/prepost-vas/prepost-vas-lowld.png", nrow = 2, ncol = 2.5, base_asp = 1.2)
...
cowplot::save_plot(vas.highld, filename = "exploratory_visualization/prepost-vas/prepost-vas-highld.png", nrow = 2, ncol = 3.5, base_asp = 1.2)
