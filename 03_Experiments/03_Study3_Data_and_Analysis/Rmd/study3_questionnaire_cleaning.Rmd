...
load("Rdata/study3_ldq_cleaning_workspace.Rdata")
```
...
save(ldq,
     ...
     squeaky_clean_part2,
     sanity.check2,
  file = "Rdata/study3_ldq_cleaning_workspace.Rdata"
)
```
...
# save unfiltered 
write_excel_csv(ldq_wide_part1, file = "data/processed/study3_ldq_wide_part1_all.csv")
...
# save unfiltered 
write_excel_csv(ldq_wide_part2, file = "data/processed/study3_ldq_wide_part2_all.csv")
...
```{r save-cleaned-data}
write_excel_csv(cleaned_part1, file = "data/processed/study3_ldq_wide_part1_cleaned.csv")
  
# save updated filtered data
write_excel_csv(squeaky_clean_part2, file = "data/processed/study3_ldq_wide_part2_cleaned.csv")
```
