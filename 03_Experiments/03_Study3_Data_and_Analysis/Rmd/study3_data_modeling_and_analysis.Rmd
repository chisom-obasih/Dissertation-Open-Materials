---
title: "Study 3 Data Modeling and Analysis"
author: "Chisom"
date: "June 2025"
...
path.to.vas.data <- "data/VAS_curvefit_output"

# logistic estimates, convert ID to factor and set factor levels for pair and prepost
l_estimates <-import(paste(path.to.vas.data, "study3_vas_l_curvefit.txt", sep = "/")) %>%
...
load("Rdata/study3_processed_dataframes_filtered_only.Rdata")
...
# load("Rdata/study3_modeling_and_analysis_workspace.Rdata")
# alternatively use
# attach("Rdata/study3_modeling_and_analysis_workspace.Rdata")
# or use a new environment
# e = local({load("Rdata/study3_modeling_and_analysis_workspace.Rdata"); environment()})
```
...
save(# loaded in
     ...
     file = "Rdata/study3_modeling_and_analysis_workspace.Rdata") 
...
save(# loaded in
     ...
     file = "Rdata/study3_dataframes_modeling_analysis_results.Rdata")
```
