---
title: "Study 1 Quantitative Results and Visualization"
author: "Chisom Obasih"
date: "May 2025"
subtitle: "Tables, figures, and graphs after running rotated logistic curvefitter and Bayesian mixed-effects models "
...
load(file = "Rdata/study1_dataframes_modeling_analysis_results.Rdata")
```
...
save(lang_colors,
     ...
     int.neg.plot,
     slopevartheta.patch,
      file = "Rdata/study1_quantitative_results_visualization_workspace.Rdata")
```

```{r reload-rdata}
# if session restarts, load in the data made here - be careful with this
load(file = save.data.file)
load(file = "Rdata/study1_quantitative_results_visualization_workspace.Rdata")
```
...
continua.table.2d <- import("../../02_Task_Materials/VAS/planning/continua-table-2d.xlsx")
...
matlab_input_trials_76 <- import("data/processed/filtered_study1_vas_matlab.txt") %>%
...
matlab_rl_curvefit_preds <- import("data/VAS_curvefit_output/study1_vas_rl_curvefit.data.txt") %>%
...
matlab_input100 <- import("data/processed/filtered_study1_vas_matlab.txt") %>%
