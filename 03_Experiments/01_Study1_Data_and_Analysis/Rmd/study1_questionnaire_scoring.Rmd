---
title: "Study 1 Questionnaire Scoring"
...
part1 <- import("data/processed/study1_ldq_wide_part1_filtered.csv")
part2 <- import("data/processed/study1_ldq_wide_part2_filtered.csv")
...
```{r write-part1-calculate-scores-function}
...
```{r write-part2-calculate-scores-function}
...
export(mld.a, file = "data/analyzed_results/study1_mld-a_scores.csv")
export(mld.p, file = "data/analyzed_results/study1_mld-p_scores.csv")
export(scores, file = "data/analyzed_results/study1_mld_scores.csv")
```
