...
ldq_files <- list.files(path = "data/raw/questionnaires", pattern = "LDQ", all.files = FALSE, full.names = TRUE, recursive = FALSE)
...
```{r save-Rdata}
# save objects made during this file to reload if session closes
save(ldq,
     ldq_long,
     ldq_long_part1,
     ldq_long_part2,
     ...
     filtered_part2,
     filtered_part1,
  file = "Rdata/study2_ldq_cleaning_workspace.Rdata"
)
```
...
# save unfiltered 
write_excel_csv(ldq_wide_part1, file = "data/processed/study2_ldq_wide_part1_all.csv")
...
# save unfiltered 
write_excel_csv(ldq_wide_part2, file = "data/processed/study2_ldq_wide_part2_all.csv")
...
write_excel_csv(filtered_part1, file = "data/processed/study2_ldq_wide_part1_filtered.csv")
  
# save updated filtered data
write_excel_csv(filtered_part2, file = "data/processed/study2_ldq_wide_part2_filtered.csv")
```
