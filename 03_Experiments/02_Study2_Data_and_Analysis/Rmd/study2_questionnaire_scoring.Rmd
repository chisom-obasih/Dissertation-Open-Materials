---
title: "Study 2 Questionnaire Scoring"
...
part1 <- import("data/processed/study2_ldq_wide_part1_filtered.csv")
part2 <- import("data/processed/study2_ldq_wide_part2_filtered.csv")

```


```{r source-scoring-functions}
# source the scoring functions from the LDQscoring.R file, which is in the LDQ subfolder of the 02_Task_Materials subdirectory
# this goes up two levels of folder from the location of the R project (03_Experiments/02_Study2_Data_and_Analysis)
# the first .. goes up one level to 03_Experiments
# the next .. goes to the top level of the Dissertation-Open-Materials repository
source("../../02_Task_Materials/LDQ/LDQscoring.R")
```
...
path.to.data <- "data/analyzed_results"

export(mld.a, file = paste(path.to.data, "study2_mld-a_scores.csv", sep = "/"))
export(mld.p, file = paste(path.to.data, "study2_mld-p_scores.csv", sep = "/"))
export(scores, file = paste(path.to.data, "study2_mld_scores.csv", sep = "/"))
```
