...
# source the scoring functions from the LDQscoring.R file, which is in the LDQ subfolder of the B_Task_Materials subdirectory
# this goes up one parent folder from the location of the R project (Study2_Data_and_Analysis)
#  .. goes to the highest level of the Dissertation-Open-Materials repository
source("../B_Task_Materials/LDQ/LDQscoring.R")
```
