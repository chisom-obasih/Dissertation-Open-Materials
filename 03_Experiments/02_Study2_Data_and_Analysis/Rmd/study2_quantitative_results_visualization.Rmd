...
continua.table.1d <- import("../B_Task_Materials/VAS/planning/continua-table-1d.xlsx")
...
# import spreadsheets
word_pairs_test <- import("../B_Task_Materials/AX_discrimination/gorilla_spreadsheets/testing_all_groups.csv") %>%
...
word_pairs_train <- import("../B_Task_Materials/AX_discrimination/gorilla_spreadsheets/training_high_LD.csv") %>%
  filter(!is.na(randomize_language_blocks)) %>%
  select(word_pair, word_A, word_B, transliteration_A:task) %>%
  distinct() %>%
  select(word_pair, transliteration_A:transliteration_B, orthography_A:gloss_B, phoneme_quality, segment_type, task)
