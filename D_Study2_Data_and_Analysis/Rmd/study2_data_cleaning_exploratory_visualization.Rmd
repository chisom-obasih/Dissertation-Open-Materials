---
title: "Study 2 Data Cleaning and Exploratory Visualization"
...
VAS_files <- list.files(path = "data/raw/VAS", pattern = "*VAS*", all.files = FALSE, full.names = TRUE, recursive = FALSE)
AX_test_files <- list.files(path = "data/raw/AX_discrimination", pattern = "*test*", all.files = FALSE, full.names = TRUE, recursive = FALSE)
AX_training_files <- list.files(path = "data/raw/AX_discrimination", pattern = "AX_training*", all.files = FALSE, full.names = TRUE, recursive = FALSE)
...
MLD_scores <- import(file = "data/analyzed_results/study2_mld_scores.csv") %>%
...
save(clean_IDs,
     ...
     training_dprime_interim,
     dprime_training,
     file = "Rdata/study2_processed_dataframes_filtered_only.Rdata")
```
...
write_excel_csv(df_vas_clean, file = "data/processed/unfiltered_study2_vas_all.csv")
```
...
export(filtered_vas, "data/processed/filtered_study2_vas.csv", row.names = F, quote = F)

# save MLD-filtered (with all the columns) as csv file
export(mld_filtered_vas, "data/processed/filtered_mld_study2_vas.csv", row.names = F, quote = F)


# save matlab (with less columns) as txt file
export(filtered_matlab, "data/processed/filtered_study2_vas_matlab.txt", sep = "\t", row.names = F, quote = F)

# save the MLD-filtered matlab as txt file
export(mld_filtered_matlab, "data/processed/filtered_mld_study2_vas_matlab.txt", sep = "\t", row.names = F, quote = F)
...
# save as csv file, saves in subfolder
write_excel_csv(testing, file = "data/processed/unfiltered_study2_AX_testing_all.csv")
```
...
# save filtered (with all the columns) as csv file
write_excel_csv(filtered_test_mad, "data/processed/filtered_mld_study2_ax_test_all_metadata.csv")

# save filtered (with less columns) as csv file
write_excel_csv(filtered_test, "data/processed/filtered_mld_study2_ax_test.csv")
```
...
# save as csv file, saves in subfolder
write_excel_csv(training, file = "data/processed/unfiltered_study2_AX_training_all.csv")
```
...
# save filtered (with all the columns) as csv file
write_excel_csv(filtered_train_mad, "data/processed/filtered_mld_study2_ax_train_all_metadata.csv")

# save filtered (with less columns) as csv file
write_excel_csv(filtered_train, "data/processed/filtered_mld_study2_ax_train.csv")
...
#   ggsave(filename = paste0("exploratory_visualization/prepost-vas/prepost_vas", i, ".png"))
# }
...
write_excel_csv(test_dprime_interim, file = "data/processed/AX_prepost_test_bytrial_dprime_labels.csv")


write_excel_csv(dprime_prepost_test, file = "data/processed/AX_prepost_test_dprime_scores.csv")
...
# ggsave(filename = "exploratory_visualization/discrimination/prepost_dprime.png")
...
#ggsave(filename = "exploratory_visualization/discrimination/prepost_rt.png")
```
