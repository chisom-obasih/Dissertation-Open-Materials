...
path.to.data <- "data/VAS_curvefit_output"
...
load("Rdata/study2_processed_dataframes_filtered_only.Rdata")
# this comes with MLD scores

# if session restarts, load the workspace - be careful with this
# load("Rdata/study2_modeling_and_analysis_workspace.Rdata")
# alternatively use
# attach("Rdata/study2_modeling_and_analysis_workspace.Rdata")
# or use a new environment
# e = local({load("Rdata/study2_modeling_and_analysis_workspace.Rdata"); environment()})
```
...
save(l_estimates,
     ...
     trial.rt.model.2,
     file = "Rdata/study2_modeling_and_analysis_workspace.Rdata")
...
save(# loaded in
     ...
     file = "Rdata/study2_dataframes_modeling_analysis_results.Rdata")
```
