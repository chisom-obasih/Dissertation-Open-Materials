...
# path.to.data <- "clean_data"

# read-in clean questionnaire data
part1 <- import("clean_data/study1_ldq_wide_part1_filtered.csv")
part2 <- import("clean_data/study1_ldq_wide_part2_filtered.csv")
...
export(mld.a, file = "clean_data/outcome_data/study1_mld-a_scores.csv")
export(mld.p, file = "clean_data/outcome_data/study1_mld-p_scores.csv")
export(scores, file = "clean_data/outcome_data/study1_mld_scores.csv")
```
